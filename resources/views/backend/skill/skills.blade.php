                ...
                <div class="inner bg-container">
                    <div class="card">
                        ...
                        <div class="card-header bg-white">
                            All Skill
                            <a class="btn btn-sm btn-success pull-right" href="{{ URL::route('add-skill') }}"">Add New</a>
                        </div>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($skills as $skill)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $skill->publish }}</td>
                                                    <td>
                                                    <a href="{{ url('/') }}/admin/skill/edit/{{ $skill->id }}" class="btn btn-sm btn-info">Edit</a>
                                                    <a href="{{ URL::route('delete-skill', $skill->id) }}" class="btn btn-sm btn-danger">Delete</a>
